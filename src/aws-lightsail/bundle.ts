...
export class Bundle {
   ...
   */
  public static readonly X2LARGE_3_0 = new Bundle('2xlarge_3_0');

  /**
   * 16vCPUs, 64.0 GB Memory, Dual-Stack
   */
  public static readonly X4LARGE_3_0 = new Bundle('4xlarge_3_0');
   ...
   * 8vCPUs, 32.0 GB Memory, Dual-Stack
   */
  public static readonly X2LARGE_WIN_3_0 = new Bundle('2xlarge_win_3_0');

  /**
   * 16vCPUs, 64.0 GB Memory, Dual-Stack
   */
  public static readonly X4LARGE_WIN_3_0 = new Bundle('4xlarge_win_3_0');
   ...
   */
  public static readonly X2LARGE_IPV6_3_0 = new Bundle('2xlarge_ipv6_3_0');

  /**
   * 16vCPUs, 64.0 GB Memory, IPv6-only
   */
  public static readonly X4LARGE_IPV6_3_0 = new Bundle('4xlarge_ipv6_3_0');
   ...
   * 8vCPUs, 32.0 GB Memory, IPv6-only
   */
  public static readonly X2LARGE_WIN_IPV6_3_0 = new Bundle('2xlarge_win_ipv6_3_0');

  /**
   * 16vCPUs, 64.0 GB Memory, IPv6-only
   */
  public static readonly X4LARGE_WIN_IPV6_3_0 = new Bundle('4xlarge_win_ipv6_3_0');
